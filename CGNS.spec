...
%prep
%setup -q -n CGNS-4.1.2
cd %{_builddir}/CGNS-4.1.2
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/CGNS-4.1.2/src/LICENSE %{buildroot}/usr/share/package-licenses/CGNS/f780297d8a4c3457ad613e1170894b5de854b4d3
cp %{_builddir}/CGNS-4.1.2/src/cgnstools/LICENSE %{buildroot}/usr/share/package-licenses/CGNS/a429c0e28adfbea645b03002dacff5f40d46da4c
pushd clr-build-openmpi
module load openmpi
