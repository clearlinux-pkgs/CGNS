...
Version  : lib.4.1.1
Release  : 5
URL      : https://github.com/CGNS/CGNS/archive/v4.1.1/cgnslib-4.1.1.tar.gz
Source0  : https://github.com/CGNS/CGNS/archive/v4.1.1/cgnslib-4.1.1.tar.gz
...
%prep
%setup -q -n CGNS-4.1.1
cd %{_builddir}/CGNS-4.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586122920
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/CGNS-4.1.1/license.txt %{buildroot}/usr/share/package-licenses/CGNS/1be7ca6b47850de97d2dd5cab74d22620d017274
cp %{_builddir}/CGNS-4.1.1/src/LICENSE %{buildroot}/usr/share/package-licenses/CGNS/f780297d8a4c3457ad613e1170894b5de854b4d3
cp %{_builddir}/CGNS-4.1.1/src/cgnstools/LICENSE %{buildroot}/usr/share/package-licenses/CGNS/a429c0e28adfbea645b03002dacff5f40d46da4c
pushd clr-build-openmpi
module load openmpi
...
/usr/lib64/openmpi/lib/libcgns.so.4.1
